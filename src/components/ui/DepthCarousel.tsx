...
const DEFAULT_ITEMS: DepthCarouselItem[] = [
  {
    ...
    alt: 'Workshop at CT Institution',
    title: 'Adversary Simulation Workshop',
    subtitle: 'CT Institution Campus, Jalandhar',
    date: 'Aug 14, 2026',
    linkedinUrl: 'https://www.linkedin.com/company/thread-security/',
  },
  {
    image: 'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=1200&auto=format&fit=crop',
    alt: 'Cloud Security Bootcamp',
    title: 'eBPF & Cloud Native Guardrails',
    subtitle: 'Thread Security Innovation Hub',
    date: 'Jul 22, 2026',
    linkedinUrl: 'https://www.linkedin.com/company/thread-security/',
  },
  {
    image: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=1200&auto=format&fit=crop',
    alt: 'Red Team Hackathon',
    title: '24-Hour Live Threat Hunting CTF',
    subtitle: 'National Cybersecurity Center',
    date: 'Jun 10, 2026',
    linkedinUrl: 'https://www.linkedin.com/company/thread-security/',
  },
  {
    image: 'https://images.unsplash.com/photo-1531482615713-2afd69097998?q=80&w=1200&auto=format&fit=crop',
    alt: 'AI Guardrails Masterclass',
    title: 'Prompt Injection & Agent Exploitation',
    subtitle: 'Online Global Symposium',
    date: 'May 28, 2026',
    linkedinUrl: 'https://www.linkedin.com/company/thread-security/',
  },
];
    ...
    >
      <div className="depth-carousel__stage" ref={stageRef}>
        {data.map((item, i) => (
          <div
            key={i}
            className="depth-carousel__card shadow-2xl transition-all"
            ref={(el) => {
