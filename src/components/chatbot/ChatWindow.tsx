...
export const ChatWindow: React.FC<ChatWindowProps> = ({
  ...
  return (
    <div className="fixed z-50 transition-all duration-300 ease-out inset-0 sm:inset-auto sm:bottom-24 sm:right-6 sm:w-[440px] sm:h-[620px] sm:max-h-[calc(100dvh-7rem)] h-dvh max-h-[100dvh] flex flex-col bg-[#0c081e]/95 border border-violet-500/30 sm:rounded-3xl shadow-2xl shadow-violet-950/50 backdrop-blur-2xl overflow-hidden animate-in fade-in zoom-in-95 safe-top safe-bottom safe-left safe-right">
      {/* Header */}
